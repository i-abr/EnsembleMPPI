...
def main():
    poses =           np.load('door-many-ax-pos.npy')
    vels =            np.load('door-many-ax-vel.npy')
    est_axis=         np.load('door-est-axis.npy')
    est_pos =         np.load('door-est-pos.npy')
    model_prob_traj = np.load('door-model-prob.npy')
