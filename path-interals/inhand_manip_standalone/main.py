...
def main():
    ...
    while True:
        ...
        env.forward()
        init_distance = get_distance(env.data)
        ...
        for t in range(final_time):
            ...
            print(stats)
            print('true values : ', mean_mass, mean_intertia, 1/np.sum(np.square(emppi.model_probs)))
        ...
        completion_time_per_dist_data.append(init_distance/t)
        cnt += 1
        data_path = 'data/images0/'
        print('saving data ....')
        #file_pi = open(data_path + 'state-data.pickle', 'wb')
        #pickle.dump(state_data, file_pi)
        #file_pi = open(data_path + 'estimation-data.pickle', 'wb')
        #pickle.dump(estimation_data, file_pi)
        #file_pi = open(data_path + 'completion-time-data.pickle', 'wb')
        #pickle.dump(completion_time_per_dist_data, file_pi)
